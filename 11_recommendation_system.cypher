...
//
// USAGE: Set parameters before running:
// :param userId => 1;
// :param movieId => 260;
//
// ================================================
...
// ------------------------------------------------
// 1. USER-BASED COLLABORATIVE FILTERING (FIXED)
// ------------------------------------------------
...
// Match target movie FIRST to avoid cartesian product
MATCH (targetMovie:Movie {movieId: $movieId})
...
// ------------------------------------------------
// 2. ITEM-BASED COLLABORATIVE FILTERING (FIXED)
// ------------------------------------------------
...
// ------------------------------------------------
// 3. COMBINED PREDICTION WITH FALLBACKS (FIXED)
// ------------------------------------------------
